...
namespace HugoLandEditeur
{
    ...
    public partial class Hero
    {
        ...
        public Nullable<System.DateTime> TimeModif { get; set; }
        public Nullable<int> AreaHorizontale { get; set; }
        public Nullable<int> AreaVerticale { get; set; }
        public byte[] RowVersion { get; set; }
        public Nullable<int> Vie { get; set; }
        public Nullable<bool> AFK { get; set; }
